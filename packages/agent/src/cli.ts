 ...
 *   BRAIN_NODES_DIR      `:`-separated list of dirs holding node types.
 ...
 *       …
 *
 * Without this, a fresh remote agent runs against `./nodes` (empty in
 * a $HOME cwd) and announces zero installable types — the dashboard
 * shows "0 type" and labels it a passive bus client.
 */
